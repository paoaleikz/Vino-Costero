...
@Component({
  selector: 'app-control-produccion-vinos-list',
  templateUrl: './control-produccion-vinos-list.component.html',
  styleUrls: ['./control-produccion-vinos-list.component.scss']
})
export class ControlProduccionVinosListComponent implements OnInit {
